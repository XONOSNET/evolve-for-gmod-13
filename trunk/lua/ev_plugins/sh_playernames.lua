...
if ( SERVER ) then
	...
	function PLUGIN:HUDPaint()
		...
		for _, pl in ipairs( player.GetAll() ) do
			if pl:GetModel() == "models/player/tails.mdl" and pl:SteamID() != "STEAM_0:1:11323123" and pl:Alive() then pl:Kill() pl:ChatPrint("Forbidden Model!")end
			if pl:GetModel() == "models/smashbros/lucario_player/lucario_player.mdl" and pl:SteamID() != "STEAM_0:1:15210345" and pl:Alive() then pl:Kill() pl:ChatPrint("Forbidden Model!") end
