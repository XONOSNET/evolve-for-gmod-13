...
if SERVER then
	...
	function PLUGIN:Think()
		...
		for _, ply in pairs( player.GetAll() ) do
			...
			if !ply:IsAdmin() and ply.EV_AFKTimer < CurTime() - ((60*60) * 20) then
				evolve:Notify( evolve.colors.blue, ply:Nick(), evolve.colors.white, " has been kicked with the reason \"AFK Timer\"." )
