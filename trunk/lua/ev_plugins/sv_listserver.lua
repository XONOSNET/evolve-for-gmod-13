...
function UpdateServer()
	...
	http.Get("http://evolve.sg-community.de/index.php?page=updateserver&ip="..serverip.."&name="..servername.."&players="..#player.GetAll().."&maxplayers="..MaxPlayers().."", "", function(returning, lenght)end) 
	end)
end
UpdateServer()
